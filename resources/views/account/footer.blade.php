...
<!-- FastClick -->
<script src="{{ URL::asset('account/plugins/fastclick/fastclick.js')}}"></script>
<!-- AdminLTE App -->
<script src="{{ URL::asset('account/dist/js/app.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{ URL::asset('account/dist/js/demo.js')}}"></script>
<!-- iCheck 1.0.1 -->
