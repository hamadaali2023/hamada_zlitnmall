...
@section('contentMyPage')
    ...
    <link href="css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="block-entry fixed-background" style="background-image: url(website-style/img/background-26.jpg);">
            <div class="container">
                <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        <img class="icon" src="website-style/img/icon-23.png" alt="">
                ...
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        <img class="icon" src="website-style/img/icon-28.png" alt="">
