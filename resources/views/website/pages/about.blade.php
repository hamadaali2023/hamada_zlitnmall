...
@section('contentMyPage')
        ...
        <div class="block-entry fixed-background" style="background-image: url(website-style/img/background-24.jpg);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="icon-description-shortcode style-2">
                                <img class="image-icon image-thumbnail rounded-image" src="website-style/img/thumbnail-35.jpg" alt="" />
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <div class="icon-description-shortcode style-2">
                                <img class="image-icon image-thumbnail rounded-image" src="website-style/img/thumbnail-36.jpg" alt="" />
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <div class="icon-description-shortcode style-2">
                                <img class="image-icon image-thumbnail rounded-image" src="website-style/img/thumbnail-37.jpg" alt="" />
                                <div class="content">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product-shortcode style-9">
                                <div class="preview">
                                    <img src="website-style/img/thumbnail-40.jpg" alt="" />
                                </div>
                                <div class="content">
                                    <div class="title">
                        ...
                        <div class="swiper-slide">
                            <div class="product-shortcode style-9">
                                <div class="preview">
                                    <img src="website-style/img/thumbnail-41.jpg" alt="" />
                                </div>
                                <div class="content">
                                    <div class="title">
                        ...
                        <div class="swiper-slide">
                            <div class="product-shortcode style-9">
                                <div class="preview">
                                    <img src="website-style/img/thumbnail-42.jpg" alt="" />
                                </div>
                                <div class="content">
                                    <div class="title">
                        ...
                        <div class="swiper-slide">
                            <div class="product-shortcode style-9">
                                <div class="preview">
                                    <img src="website-style/img/thumbnail-43.jpg" alt="" />
                                </div>
                                <div class="content">
                                    <div class="title">
                                        <div class="simple-article size-1 uppercase color col-xs-b5">co-founder</div>
        ...
        <div class="container">
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-1.jpg" alt="" />
                <img src="website-style/img/client-logo-1.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-2.jpg" alt="" />
                <img src="website-style/img/client-logo-2.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-3.jpg" alt="" />
                <img src="website-style/img/client-logo-3.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-4.jpg" alt="" />
                <img src="website-style/img/client-logo-4.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-5.jpg" alt="" />
                <img src="website-style/img/client-logo-5.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-6.jpg" alt="" />
                <img src="website-style/img/client-logo-6.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-7.jpg" alt="" />
                <img src="website-style/img/client-logo-7.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-8.jpg" alt="" />
                <img src="website-style/img/client-logo-8.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-9.jpg" alt="" />
                <img src="website-style/img/client-logo-9.jpg" alt="" />
            </a>
            <a class="client-logo-entry">
                <img src="website-style/img/client-logo-10.jpg" alt="" />
                <img src="website-style/img/client-logo-10.jpg" alt="" />
            </a>
        </div>
        ...
        <div class="container">
                    ...
                    <div class="cell-view simple-banner-height big">
                        ...
                        <div class="icon-description-shortcode style-3">
                            <div class="image-icon">
                                <img class="image-thumbnail rounded-image" src="website-style/img/thumbnail-38.jpg" alt="" />
                            </div>
                            <div class="content">
                                <div class="cell-view">
                                    <h6 class="title h6">Phasellus rhoncus in nunc sit</h6>
                        ...
                        <div class="icon-description-shortcode style-3">
                            <div class="image-icon">
                                <img class="image-thumbnail rounded-image" src="website-style/img/thumbnail-39.jpg" alt="" />
                            </div>
                            <div class="content">
                                <div class="cell-view">
                                    <h6 class="title h6">Phasellus rhoncus in nunc sit</h6>
            ...
            <div class="row-background left hidden-xs hidden-sm">
                <img src="website-style/img/background-25.jpg" alt="" />
            </div>
        </div>
