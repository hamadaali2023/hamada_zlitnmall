                   ...
                   <div class="swiper-slide">
                        <div class="container">
                                ...
                                <div class="col-sm-6">
                                    <div class="cell-view page-height">
                                        ...
                                        <div data-swiper-parallax-x="-600">
                                            <div class="simple-article color uppercase size-5">-30% off</div>
                                            <div class="col-xs-b5"></div>
                                        </div>
                                        <div data-swiper-parallax-x="-500">
                                            <h1 class="h1">smart watchs in our store</h1>
                            ...
                            <div class="slider-product-preview">
                                <img src="website-style/img/product-preview-4.jpg" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-b30 col-md-b0">
                        <div class="banner-shortcode style-6">
                            <img class="image" src="website-style/img/product-130.jpg" alt="" />
                            <div class="content">
                                <div class="cell-view">
                                    <h4 class="title h4 col-xs-b5"><span class="color">big summer sale</span> <br/> on all smartphones</h4>
                    ...
                    <div class="col-md-6">
                        <div class="banner-shortcode style-6">
                            <img class="image" src="website-style/img/product-131.jpg" alt="" />
                            <div class="content">
                                <div class="cell-view">
                                    <h4 class="title h4 col-xs-b5">new trends in laptops design</h4>
                                    <div class="description simple-article size-2 col-xs-b10">Quisque rhoncus orci vitae nisl rutrum rutrum lesuada laoreet urna sed</div>
                ...
                <div class="tabs-block">
                        ...
                        <div class="col-lg-8">
                            <div class="tabulation-menu-wrapper col-lg-text-right">
                                ...
                                <ul class="tabulation-toggle">
                                    <li><a class="tab-menu active">smartphones</a></li>
                                    <li><a class="tab-menu">laptops</a></li>
                                    <li><a class="tab-menu">pc</a></li>
                                    <li><a class="tab-menu">gadegets</a></li>
                    ...
                    <div class="tab-entry visible">
                        <div class="row nopadding">
                            <div class="col-lg-6">
                                <div class="slider-wrapper side-borders grid-products-4-items">
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="product-shortcode style-3 big">
                                                    <div class="empty-space col-xs-b35 col-md-b70"></div>
                                                    <div class="swiper-container" data-loop="1" data-touch="0">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide">
                                                                <img src="website-style/img/product-118.jpg" alt="" />
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <img src="website-style/img/product-119.jpg" alt="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="empty-space col-xs-b35 col-md-b70"></div>
                                                    <div class="h4 animate-to-green"><a href="#">smart watch zeseries</a></div>
                                                    <div class="empty-space col-xs-b10"></div>
                                                    <div class="description">
                                                        <div class="simple-article size-2">Sed id purus ac arcu pulvinar euismod natoque</div>
                                                    </div>
                                ...
                                <div class="row nopadding">
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            <div class="title">
                                                <div class="simple-article size-1 color col-xs-b5"><a href="#">SMART WATCHES</a></div>
                                                <div class="h6 animate-to-green"><a href="#">SmartWatch 3 SWR50</a></div>
                                            </div>
                                            <div class="preview">
                                                <img src="website-style/img/product-120.jpg" alt="">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-121.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-122.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-123.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                ...
                                <div class="row nopadding">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="img/product-121.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="img/product-122.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="img/product-123.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
               ...
               <div class="swiper-wrapper">
                   <div class="swiper-slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="cell-view simple-banner-height big">
                                        ...
                                        <div data-swiper-parallax-x="-600">
                                            <div class="simple-article size-3">HEADPHONES</div>
                                            <div class="col-xs-b5"></div>
                                        </div>
                                        <div data-swiper-parallax-x="-500">
                                            <h2 class="h2">Sport Wireless+</h2>
                                            <div class="title-underline left"><span></span></div>
                                        </div>
                                        <div data-swiper-parallax-x="-400">
                                            <div class="simple-article size-4 col-xs-b20">
                                        ...
                                        <div data-swiper-parallax-x="-300">
                                            <div class="buttons-wrapper">
                                                <div class="simple-article size-5 grey">BEST PRICE: <span class="color">$195.00</span></div>
                                                <a class="button size-2 style-3" href="#">
                                                    <span class="button-wrapper">
                                                        <span class="icon"><img src="website-style/img/icon-4.png" alt=""></span>
                                                        <span class="text">Learn More</span>
                                                ...
                                                <a class="button size-2 style-2" href="#">
                                                    <span class="button-wrapper">
                                                        <span class="icon"><img src="website-style/img/icon-2.png" alt=""></span>
                                                        <span class="text">Add To Cart</span>
                                                    </span>
                                                </a>
                                            </div>
                            ...
                            <div class="slider-product-preview">
                                <img src="website-style/img/product-preview-21.png" alt="">
                            </div>
                            <div class="empty-space col-xs-b80 col-sm-b0"></div>
                        </div>
                   </div>
            ...
            <div class="container">
                ...
                <div class="tabs-block">                                    
                    <div class="tab-entry">
                        <div class="row nopadding">
                            <div class="col-lg-6">
                                <div class="slider-wrapper side-borders grid-products-2-items">
                                    <div class="swiper-container">
                                        <div class="swiper-button-prev hidden"></div>
                                        <div class="swiper-button-next hidden"></div>
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="product-shortcode style-1 float">
                                                    <div class="title">
                                                        <div class="simple-article size-1 color col-xs-b5"><a href="#">SMART WATCHES</a></div>
                                                        <div class="h6 animate-to-green"><a href="#">SmartWatch 3 SWR50</a></div>
                                                    </div>
                                                    <div class="preview">
                                                        <img src="website-style/img/product-124.jpg" alt="">
                                                        <div class="preview-buttons valign-middle">
                                                            <div class="valign-middle-content">
                                                                <a class="button size-2 style-2" href="#">
                                                                    <span class="button-wrapper">
                                        ...
                                        <div class="swiper-pagination md-relative-pagination"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="row nopadding">
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-125.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="img/product-126.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                ...
                                <div class="row nopadding">
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-127.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-128.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="product-shortcode style-1 float">
                                                    ...
                                                    <div class="preview">
                                                        <img src="website-style/img/product-129.jpg" alt="">
                                                        <div class="preview-buttons valign-middle">
                                                            <div class="valign-middle-content">
                                                                <a class="button size-2 style-2" href="#">
                                                                    <span class="button-wrapper">
                                ...
                                <div class="row nopadding">
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="img/product-127.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="img/product-128.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
                                ...
                                <div class="row nopadding">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="product-shortcode style-1">
                                            ...
                                            <div class="preview">
                                                <img src="website-style/img/product-126.jpg" alt="">
                                                <div class="preview-buttons valign-middle">
                                                    <div class="valign-middle-content">
                                                        <a class="button size-2 style-2" href="#">
                                                            <span class="button-wrapper">
        ...
        <div class="row nopadding">
            <div class="col-sm-6 col-lg-3">
                <div class="icon-description-shortcode style-4">
                    <img class="icon-image" src="website-style/img/icon-22.png" alt="">
                    <div class="cell-view">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="icon-description-shortcode style-4">
                    <img class="icon-image" src="website-style/img/icon-23.png" alt="">
                    <div class="cell-view">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="icon-description-shortcode style-4">
                    <img class="icon-image" src="website-style/img/icon-24.png" alt="">
                    <div class="cell-view">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="icon-description-shortcode style-4">
                    <img class="icon-image" src="website-style/img/icon-25.png" alt="">
                    <div class="cell-view">
