...
<head>
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    ...
    <link rel="stylesheet" href="{{ URL::asset('website-style/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('website-style/css/bootstrap.extension.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('website-style/css/style.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('website-style/css/swiper.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('website-style/css/sumoselect.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('website-style/css/font-awesome.min.css') }}">
  
  
      

    <link rel="shortcut icon" href="website-style/img/favicon.ico" />
    <title>EX ZO</title>
</head>
...
<body>
  ...
  <!-- LOADER -->
                    ...
                    <div class="row">
                        <div class="col-md-3 hidden-xs hidden-sm">                   
                            ...
                            <div class="entry hidden-xs hidden-sm cart">
                                ...
                                <div style="    width: 355px !important; left: 10px !important;;" class="cart-toggle hidden-xs hidden-sm">                        
                                    <div class="empty-space col-xs-b40"></div>
                                    <div class="row">                                        
                                        <div class="col-xs-12 ">
                                             <span class="text">email: office@exzo.com</span>
                                        </div>
                                    </div>
                                   <div class="row">                                        
                                        <div class="col-xs-12 ">
                        ...
                        <div class="col-md-9 col-md-text-right">
                            <div class="entry">
                            ...
                            <div class="entry language" >
                                <div class=""><b>  <a href="{{url('blog')}}">BLOG </a></b></div>
                                <div  style="width: 164%;" class="language-toggle  header-toggle-animation">
                                    <a style="padding: 0px 5px !important;" href="{{url('blog')}}">BLOG LANDING PAGES</a>
                                    <a style="padding: 0px 5px !important;" href="{{url('blogdetail')}}">BLOG DETAIL PAGES</a>                                    
                                </div>
                            </div>
                                ...
                                <div class="cart-toggle hidden-xs hidden-sm">
                                    <div class="cart-overflow">
                                        <div class="cart-entry clearfix">
                                            <a class="cart-entry-thumbnail" href="#"><img src="website-style/img/product-1.png" alt="" /></a>
                                        ...
                                        <div class="cart-entry clearfix">
                                            <a class="cart-entry-thumbnail" href="#"><img src="website-style/img/product-2.png" alt="" /></a>
                                            <div class="cart-entry-description">
                                                <table>
                                                    <tr>
                                                        <td>
                                        ...
                                        <div class="cart-entry clearfix">
                                            <a class="cart-entry-thumbnail" href="#"><img src="website-style/img/product-3.png" alt="" /></a>
                                            <div class="cart-entry-description">
                                                <table>
                                                    <tr>
                                                        <td>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <a class="button size-2 style-3" href="{{url('checkout')}}">
                                                <span class="button-wrapper">
                                                    <span class="icon"><img src="website-style/img/icon-4.png" alt=""></span>
                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-xs-3 col-sm-1">
                            <a id="logo" href="index1.html"><img src="website-style/img/logo-2.png" alt="" /></a>  
                        </div>
                            ...
                            <div class="nav-wrapper">
                                ...
                                <nav>
                                    <ul>
                                                                    ...
                                                                    <div class="swiper-container" data-loop="1">
                                                                        ...
                                                                        <div class="swiper-wrapper">
                                                                            <div class="swiper-slide">
                                                                                <img src="website-style/img/product-59.jpg" alt="" />
                                                                            </div>
                                                                            <div class="swiper-slide">
                                                                                <img src="website-style/img/product-61.jpg" alt="" />
                                                                            </div>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                ...
                                                                <div class="preview-buttons">
                                                                    <div class="buttons-wrapper">
                                                                        <a class="button size-2 style-2" href="product.html">
                                                                            <span class="button-wrapper">
                                                                                <span class="icon"><img src="website-style/img/icon-1.png" alt=""></span>
                                                                                <span class="text">Learn More</span>
                                                                            </span>
                                                                        </a>
                                                                        <a class="button size-2 style-3" href="#">
                                                                            <span class="button-wrapper">
                                                                                <span class="icon"><img src="website-style/img/icon-3.png" alt=""></span>
                                                            ...
                                                            <div class="product-shortcode style-5">
                                                                ...
                                                                <div class="preview">
                                                                    <div class="swiper-container" data-loop="1">
                                                                        ...
                                                                        <div class="swiper-wrapper">
                                                                            <div class="swiper-slide">
                                                                                <img src="website-style/img/product-60.jpg" alt="" />
                                                                            </div>
                                                                            <div class="swiper-slide">
                                                                                <img src="website-style/img/product-61.jpg" alt="" />
                                                                            </div>
                                        ...
                                        <li><a href="{{url('/shopmen')}}">shop men</a></li>
                                        <li><a href="{{url('/shopwomen')}}">shop women</a></li>
                                        <li><a href="{{url('/shopchildren')}}">shop children</a></li>                                  
                                        <li class="megamenu-wrapper">
                                            <a href="#">Pages</a>
                                            <div class="menu-toggle"></div>
                                            <div class="megamenu">
                                                <div class="links">
                                                    <a class="active" href="{{url('checkout')}}">Checkout 1</a>
                                                    <a href="{{url('checkoutt')}}">Checkout 2</a>
                                                ...
                                                <div class="content">
                                                    <div class="row nopadding">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="banner-shortcode style-3 rounded-image text-center" style="background-image: url(website-style/img/background-11.jpg);">
                ...
                <div class="footer-top">
                    <div class="row">
                        <div class="col-sm-6 col-md-3 col-xs-b30 col-md-b0">
                            <img src="website-style/img/logo-1.png" alt="" />
                        ...
                        <div class="col-sm-6 col-md-3 col-xs-b30 col-sm-b0">
                            ...
                            <div class="footer-post-preview clearfix">
                                <a class="image" href="#"><img src="website-style/img/thumbnail-1.jpg" alt="" /></a>
                                <div class="description">
                            ...
                            <div class="footer-post-preview clearfix">
                                <a class="image" href="#"><img src="website-style/img/thumbnail-2.jpg" alt="" /></a>
                                <div class="description">
                                    <div class="date">apr 07 / 15</div>
                                    <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                                </div>
                            ...
                            <div class="footer-post-preview clearfix">
                                <a class="image" href="#"><img src="website-style/img/thumbnail-3.jpg" alt="" /></a>
                                <div class="description">
                                    <div class="date">apr 07 / 15</div>
                                    <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-xs-text-center col-lg-text-right">
                            <div class="footer-payment-icons">
                                <a class="entry"><img src="website-style/img/thumbnail-4.jpg" alt="" /></a>
                                <a class="entry"><img src="website-style/img/thumbnail-5.jpg" alt="" /></a>
                                <a class="entry"><img src="website-style/img/thumbnail-6.jpg" alt="" /></a>
                                <a class="entry"><img src="website-style/img/thumbnail-7.jpg" alt="" /></a>
                                <a class="entry"><img src="website-style/img/thumbnail-8.jpg" alt="" /></a>
                                <a class="entry"><img src="website-style/img/thumbnail-9.jpg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="website-style/js/jquery-2.2.4.min.js"></script>
    <script src="website-style/js/swiper.jquery.min.js"></script>
    <script src="website-style/js/global.js"></script>
    <script src="website-style/js/jquery.sumoselect.min.js"></script>
    <script src="website-style/js/jquery.classycountdown.js"></script>
    <script src="website-style/js/jquery.knob.js"></script>
    <script src="website-style/js/jquery.throttle.js"></script>
    <script src="website-style/js/jquery-ui.min.js"></script>
    <script src="website-style/js/jquery.ui.touch-punch.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js"></script>
    <script src="website-style/js/map.js"></script>
    <script src="website-style/js/contact.form.js"></script>
    <script src="website-style/js/isotope.pkgd.min.js"></script>
